---
name: code-standards
description: Reviews code changes for potential deviation from the standards that keep this Project Hub codebase clean and tidy.  Use when planning or proposing new features or significant changes to existing code.
---
...
This is not a commercial product serving the needs of a diverse install base. It is not built by or for professional web developers. This is a small, internal project designed for access and extensibility primarily by internal Vimeo sales engineering colleagues. The audience is technically savvy, but they are not fluent JS programmers.

1. Do not introduce new features or architecture that make the project “impressive” in a way that makes it less usable for its non-developer authors and maintainers.
...
3. What is does need are clean routes, clean data model, reusable templates, reusable CSS, secure handling of secrets, clear README documentation, simple deployment notes, and a predictable way to add the next tool.
...
2. Look for opportunities to avoid overengineering, unclear naming, duplicated patterns, unnecessary dependencies, fragile routing, and security issues.
